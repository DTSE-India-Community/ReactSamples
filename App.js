...
const Permissions = () => {
  ...
  const hasLocationPermissionText =
    hasLocationPermission
      ? "Location permissions are granted."
      : "Location permissions are not granted.";

  const hasActivityIdentificationPermissionText =
  ...
  return (
    <>
      ...
      <View style={styles.sectionContainer}>
        ...
        <View style={styles.spaceBetweenRow}>
          <Text style={styles.sectionDescription}>{hasLocationPermissionText}</Text>
        </View>
      </View>
      ...
      <View style={styles.sectionContainer}>
        ...
        <View style={styles.spaceBetweenRow}>
          <Text style={styles.sectionDescription}>{hasActivityIdentificationPermissionText}</Text>
        </View>
      </View>
    </>
  )
    ...
    <>
      <View style={styles.sectionContainer}>
        <View style={styles.spaceBetweenRow}>
          ...
          <Button title="Check" 
          color="green"
          onPress={getLocationAvailability} />
        </View>
        <View style={styles.spaceBetweenRow}>
    ...
    <>
      <View style={styles.sectionContainer}>
        <View style={styles.spaceBetweenRow}>
          ...
          <Button title="Get last location"
           color="green"
           onPress={getLocation} />
        </View>
        <View style={styles.spaceBetweenRow}>
        ...
        <View style={styles.spaceBetweenRow}>
          <Text style={styles.sectionDescription}>
            <Text style={styles.boldText}>SPEED</Text>:{' '}
            {position?.speed || 0}
          </Text>
        </View>
        <View style={styles.spaceBetweenRow}>
